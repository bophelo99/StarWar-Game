...
void Menu::initializer()
{
    ...
    if (fullScreenn)
        window1.create(sf::VideoMode(width, height), "Defender: Space Wars", sf::Style::Fullscreen);
    else
        window1.create(sf::VideoMode(width, height), "Defender: Space Wars");
